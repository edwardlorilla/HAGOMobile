    ...
    <div>
        ...
        <div class="w3-row">
            <div class="w3-container w3-half">
                ...
                <img ref="imag" style="width: 90%;" :src="image"/>
                <div v-if="!image">
                    <section>
...
<script>
    import {repositoryEdit, allId, plantPush,
        updateRepository,
        currentPage,
        capturePhoto,
        cnvrtRGBClrToHex,
    ...
    export default{
        ...
        methods: {
            ...
            addBaseColor(){
                ...
                updateRepository(vm.repositoryEdit.edit, vm.selected, firebase.auth().currentUser.uid)
        ...
        mounted(){
            ...
            vm.selected.vegetation = vm.repositoryEdit.edit.vegetations
